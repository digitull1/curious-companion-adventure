...
const StatsBar: React.FC<StatsBarProps> = ({ 
  ...
  return (
    <div className="bg-white/60 backdrop-blur-sm border-b border-wonder-purple/10 px-4 py-2.5 sticky top-0 z-30">
      <div className="w-full mx-auto">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="hidden sm:block h-8 border-l border-wonder-purple/10 mx-1"></div>
