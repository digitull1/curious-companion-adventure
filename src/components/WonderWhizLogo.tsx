...
const WonderWhizLogo: React.FC<WonderWhizLogoProps> = ({ 
  ...
  useEffect(() => {
    if (logoRef.current) {
      const sparkleElements = Array.from({ length: 3 }).map(() => {
  ...
  return (
    ...
    >
      ...
      <span className="bg-clip-text text-transparent bg-gradient-to-r from-wonder-teal to-wonder-teal-dark">Whiz</span>
